...
namespace UploadProject.Pages
{
    public class CompetitorModel(ApplicationDbContext db) : PageModel
    {
        ...
        {
            Competitor = _db.Users.FirstOrDefault(x => x.ID == new Guid(CompetitorID))!;
            ...
            if (Action == "DownloadTP")
            {
                ...
                return File(memoryStream.ToArray(), "application/zip", $"Cases-{DateTime.Now:yyyy-MM-dd_HH:mm:ss}.zip");
            }
